...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://172.16.2.37:3306/dds?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false","dds","!DDS2023")
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("model")//实体类包名
                .parent("com.tencent.wxcloudrun")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
